...
namespace BreadOven.Repository.Migrations
{
    ...
    [Migration("20250304113233_cleancodeinit")]
    partial class cleancodeinit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BreadOven.core.Models.CostsAndDistrubutionfromitem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BreadOven.core.Models.FactoryLines", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BreadOven.core.Models.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BreadOven.core.Models.ProductionLineDepreciation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BreadOven.core.Models.UnitProduction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("costsAndDistributionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("costsAndDistributionId");
            ...
            modelBuilder.Entity("BreadOven.core.Models.CostsAndDistrubutionfromitem", b =>
                {
                    b.HasOne("BreadOven.core.Models.Item", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("BreadOven.core.Models.Item", b =>
                {
                    b.HasOne("BreadOven.core.Models.FactoryLines", "FactoryLines")
                        .WithMany()
            ...
            modelBuilder.Entity("BreadOven.core.Models.UnitProduction", b =>
                {
                    b.HasOne("BreadOven.core.Models.CostsAndDistrubutionfromitem", "CostsAndDistrubutionfromitem")
                        .WithMany()
                        .HasForeignKey("costsAndDistributionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CostsAndDistrubutionfromitem");
                });
